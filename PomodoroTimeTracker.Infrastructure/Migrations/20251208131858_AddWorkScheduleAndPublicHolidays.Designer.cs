...
namespace PomodoroTimeTracker.Infrastructure.Migrations
{
    ...
    [Migration("20251208131858_AddWorkScheduleAndPublicHolidays")]
    partial class AddWorkScheduleAndPublicHolidays
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PomodoroTimeTracker.Domain.Entities.AppSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("LastOpenedSettingsTab")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("WeekYearStandard")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PomodoroTimeTracker.Domain.Entities.PublicHoliday", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PomodoroTimeTracker.Domain.Entities.WorkSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<decimal>("BaseHoursPerDay")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(4, 2)
                        .HasColumnType("TEXT")
                    ...
                    b.ToTable("WorkSchedules", t =>
                        {
                            t.HasCheckConstraint("CK_WorkSchedule_ClientOrProject", "(ClientId IS NOT NULL AND ProjectId IS NULL) OR (ClientId IS NULL AND ProjectId IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("PomodoroTimeTracker.Domain.Entities.WorkSchedule", b =>
                {
                    b.HasOne("PomodoroTimeTracker.Domain.Entities.Client", "Client")
                        .WithOne()
                        .HasForeignKey("PomodoroTimeTracker.Domain.Entities.WorkSchedule", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("PomodoroTimeTracker.Domain.Entities.Project", "Project")
                        .WithOne()
                        .HasForeignKey("PomodoroTimeTracker.Domain.Entities.WorkSchedule", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade);
